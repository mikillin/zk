...
public class CarServiceImpl implements CarService {
	...
	private List<Survey> frageboegenList = new LinkedList<Survey>();
...
//            );
		...
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json1).getAsJsonObject(), Survey.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json2).getAsJsonObject(), Survey.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json21).getAsJsonObject(), Survey.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json4).getAsJsonObject(), Survey.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json5).getAsJsonObject(), Survey.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json3).getAsJsonObject(), Survey.class));
