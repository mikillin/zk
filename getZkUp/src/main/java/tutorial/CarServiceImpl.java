...
//            );
		...
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json1).getAsJsonObject(), Fragebogen.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json2).getAsJsonObject(), Fragebogen.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json21).getAsJsonObject(), Fragebogen.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json4).getAsJsonObject(), Fragebogen.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json5).getAsJsonObject(), Fragebogen.class));
		frageboegenList.add(new Gson().fromJson(new JsonParser().parse(json3).getAsJsonObject(), Fragebogen.class));
